...
class Fb extends OAuthAbstract
{
	...
	{
		$params = array(
			'client_id' => $this->getSettingsService()->get('social.fb_appid'),
	...
	protected function findUser()
	{
		...
		if (isset($this->data['email'])) {
			return $this->getUserService()->getUserByEmail($this->data['email']);
		} else {
			return $this->getUserService()->getUserByFbId($this->data['id']);
		}
	}
	...
	protected function getData()
	{
		if (!$this->data) {
			...
			$params = array(
				'client_id' => $this->getSettingsService()->get('social.fb_appid'),
				'redirect_uri' => $this->generateUrl('_fb_redirect', array(), true) . $this->getBackUrl(),
				'client_secret' => $this->getSettingsService()->get('social.fb_secret'),
				'code' => $incoming['code'],
			);
			...
			$fb = new \Facebook(array(
				'appId' => $this->getSettingsService()->get('social.fb_appid'),
				'secret' => $this->getSettingsService()->get('social.fb_secret'),
			));
